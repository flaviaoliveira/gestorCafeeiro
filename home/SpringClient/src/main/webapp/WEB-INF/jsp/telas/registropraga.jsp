			...
			<div class="panel panel-primary">
				<div class="panel-body">
					<form method="POST" action="">
						...
						<div class="form-group">
							<label class="control-label" for="nome">Praga ou Doença:</label> <input
								name="nome" type="text" maxlength="50" class="form-control">
						</div>
						
						<div class="form-group">
							<label class="control-label" for="nome">Data inicial da ocorrência:</label> <input
								name="nome" type="text" maxlength="50" class="form-control">
						</div>
						<div class="form-group">
							<label class="control-label" for="nome">Data final da ocorrência:</label> <input
								name="nome" type="text" maxlength="50" class="form-control">
						</div>
						<div class="form-group">
							<button id="cadastraTalhao" type="submit"
								class="btn btn-info btn-block">Registrar</button>
						</div>
					</form>
				</div>
			</div>
